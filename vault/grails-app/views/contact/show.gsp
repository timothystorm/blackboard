        ...
        <div id="show-contact" class="content" role="main">
            ...
            <ol class="property-list contact">
              ...
              <li class="fieldcontain">
                ...
                <div class="property-value"><g:select name="resources" from="${contact.resources}" optionValue="${{it.eai+' - '+it.name}}" multiple="true" size="4" optionKey="eai" disabled="true"/></div>
              </li>         
            </ol>
            <g:form resource="${contact}" method="DELETE" id="${contact.ldap}">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${contact}" id="${contact.ldap}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
