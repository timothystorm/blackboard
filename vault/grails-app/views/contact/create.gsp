...
<html>
    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                <li><g:link class="list" action="index" controller="contact"><g:message code="default.list.label" args="[entityName]" /></g:link></li>
            </ul>
        </div>
        <div id="create-contact" class="contact" role="main">
            ...
            <g:form action="save">
                <fieldset class="form">
                  ...
                  <div class="fieldcontain required">
                    <label for="name.given">Name</label><g:field type="text" name="name.given" value="${contact.name?.given}" required="true" placeholder="First Name"/>
                  </div>
                  <div class="fieldcontain required">
                    <label for="name.family"></label><g:field type="text" name="name.family" value="${contact.name?.family}" required="true" placeholder="Last Name"/>
                  </div>
                  <div class="fieldcontain required">
