        ...
        <div id="edit-contact" class="content" role="main">
            ...
            <g:form resource="${contact}" method="PUT" id="${contact?.ldap}">
                ...
                <fieldset class="form">
                    ...
                    <div class="fieldcontain required">
                        <label for="name.given">Name</label><g:field type="text" name="name.given" value="${contact.name?.given}" required="true"/>
                    </div>
                    <div class="fieldcontain">
                        <label for="name.family"></label><g:field type="text" name="name.family" value="${contact.name?.family}" required="true"/>
                    </div>
                    <div class="fieldcontain">
