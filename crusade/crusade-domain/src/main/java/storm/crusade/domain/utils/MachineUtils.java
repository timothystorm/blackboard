...
/**
 * Machine (physical and JVM) utilities to identify attributes of this runtime machine.
 * 
 * @author <a href="timothystorm@gmail.com">Timothy Storm</a>
 */
public class MachineUtils {
    /**
     * Cache localhost because it <b>should not</b> change while the JVM is running.
     */
     ...
     * <p/>
     * 
     * @return localhost or null if any failures determining this machines network address.
     */
                        ...
                        for (Enumeration<NetworkInterface> nets = NetworkInterface.getNetworkInterfaces(); nets
                            ...
                            for (Enumeration<InetAddress> inets = n.getInetAddresses(); inets.hasMoreElements();) {
                                ...
                                if (!i.isLoopbackAddress()) {
                                    // short circuit because a site local address was found
    ...
    /**
     * Determines hardware address of the interface if it has one and if it can be accessed given the current
     * privileges.
     * 
    ...
    /**
     * @return this machines identity which is the merge of the DNS name and IP ex. my.machine.id:10.4.3.121
     */
